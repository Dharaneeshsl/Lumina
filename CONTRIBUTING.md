...
3. **Add or update tests** — aim for coverage on new code
4. **Pass all CI checks** — linting, type checking, and tests must be green
5. **Request a review** from at least one maintainer
6. **Respond to feedback** promptly and respectfully
