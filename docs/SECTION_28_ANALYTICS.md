...
The analytics service uses a repository interface. The API currently wires the repository boundary through the application adapter, allowing replacement with Lumina's durable Prisma/queue infrastructure without changing analytics contracts.
