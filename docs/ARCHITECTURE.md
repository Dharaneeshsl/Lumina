...
The current, code-aligned architecture documentation lives in [docs/architecture](architecture/README.md).

- [System, backend, frontend, database, authentication, cache, deployment, and external-service architecture](architecture/README.md)
